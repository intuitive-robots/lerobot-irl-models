...
def main(cfg: DictConfig) -> None:
    ...
    default_stats_path = (
        cfg.stats_path
    )  # "/home/multimodallearning/data_collected/flower-lerobot/trickandtreat/trickandtreat_lerobot/meta/stats.json"
    if os.path.exists(default_stats_path):
        ...
        for key, value in stats_json.items():
            if key in [
                ...
                dataset_stats[key] = {
                    stats_type: torch.tensor(stats, dtype=torch.float32)
