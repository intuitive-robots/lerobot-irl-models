...
#SBATCH -J train_xvla
#SBATCH -o logs/train_xvla/%x_%j.out
#SBATCH -e logs/train_xvla/%x_%j.err



# commented out SBATCH --cpus-per-task=6
# ==============================================================================
# ENVIRONMENT SETUP
# ==============================================================================
source ~/.bashrc
...
export WANDB_LOG_MODEL=false #do not upload model to wandb
